...
String timeUntilDate(int targetTimestampMillis) {
  final DateTime targetDate =
      DateTime.fromMillisecondsSinceEpoch(targetTimestampMillis);
  final DateTime now = DateTime.now();
  final Duration remainingDuration = targetDate.difference(now);
